...
//        ConseguirDatosDocente(iddocentelog);
    ...
    /**
     * Metodo para el llenado de la tabla con los registros de la base de datos
     */
    ...
    /**
     * Evento utilizado para el llenado de campos en la vista al realizar doble click sobre un registro
     * @param evt 
     */
    ...
    private void tbPerfilMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPerfilMouseClicked
        ...
        if (evt.getClickCount() == 1) {
            ...
            lblNombre.setText("Perfil: " + rcp.getModel().getValueAt(rcp.getSelectedRow(), 1).toString());
...
//            String notas = ("" + rcp.getModel().getValueAt(rcp.getSelectedRow(), 3).toString());
            String Estado = ("" + rcp.getModel().getValueAt(rcp.getSelectedRow(), 6).toString());
...
//            
           ...
           switch (Estado) {
                ...
                case "No entregado":
                    ...
                    break;
                case "En proceso":
                    custom.changeIconlbl(lblEstado, "/resources/more-square-state.png");
                    break;
                case "Urgente":
...
//        }
    ...
    /**
     * Metodo utilizado para la busqueda filtrada por medio de combobox
     */

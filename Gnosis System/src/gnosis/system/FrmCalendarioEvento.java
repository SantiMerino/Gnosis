 ...
 * @author devro
 */
public class FrmCalendarioEvento extends javax.swing.JFrame {

    /**
     * Creates new form FrmCalendario
     */
    public FrmCalendarioEvento() {
        initComponents();
        CargarTipoEvento();
        CargarGrado();
        CargarSeccion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCalendarioEvento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCalendarioEvento().setVisible(true);
            }
        });
    }

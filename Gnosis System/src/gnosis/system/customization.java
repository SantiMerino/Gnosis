...
//        btnCarpeta.setStyle(ButtonRound.ButtonStyle.VERDE);
    ...
    public void CrearTareaDashboard(String nombre_tarea, String nombre_materia, String nombre_docente,String fecha_i ,String fecha_v, String estado, JPanel container, String materiamoduloColor, int idtarea, int niveluser, int iddocente, int idalumno){
            //Crear labels   
        JLabel nTarea = new JLabel();
        JLabel nMateria = new JLabel();
        JLabel nDocente = new JLabel();
...
//        Dimensionar los paneles de contención
    ...
    public void CrearRecursoBibliotecaDashboard( String nombre_recurso, String tipo_recurso, String categoria_recurso,JPanel mainContainer, String link, String pdf) {
        // Crear paneles
        PanelRound resourcesContainer = new PanelRound();
        PanelRound topGap = new PanelRound();
        PanelRound bottomGap = new PanelRound();
...
//        JLabel lblnumpag = new JLabel();
        ...
        //Definir tipo de letra
        lblmateria.setFont(new Font("Poppins Black", Font.PLAIN, 18));
        lbldocente.setFont(new Font("Poppins", Font.PLAIN, 12));
//        lblnumpag.setFont(new Font("Poppins", Font.BOLD, 12));
        lblgrado.setFont(new Font("Poppins", Font.BOLD, 16));
        btnAbrir.setFont(new Font("Poppins", Font.BOLD, 14));
